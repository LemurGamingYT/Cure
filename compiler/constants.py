...
ATTRIBUTES = {
    ...
    Type.math: {
        ...
        'log10': Attribute(Type.float, is_method=True),
        'log2': Attribute(Type.float, is_method=True),
        'round': Attribute(Type.int, is_method=True),
        'sign': Attribute(Type.int, is_method=True),
        'max': Attribute(Type.int, is_method=True),
        'min': Attribute(Type.int, is_method=True),
    },
    Type.system: {
        'exit': Attribute(Type.nil, is_method=True),
        'shell': Attribute(Type.int, is_method=True),
        'cure_version': Attribute(Type.string),
        ...
        'print_string': Attribute(Type.nil, is_method=True),
    },
    Type.file: {
        ...
        'close': Attribute(Type.nil, False, True),
