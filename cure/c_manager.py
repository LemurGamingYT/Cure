...
HEADER = (Path(__file__).parent / 'header.h').absolute().as_posix()
...
def c_dec(
    ...
    overloads: dict[tuple[str, ...]: Callable] | None = None,
...
class CManager:
    RESERVED_NAMES = [
        ...
        'goto', 'restrict', 'unsigned', 'inline', 'auto', 'asm', 'signed'
    ]
...
""")
    ...
    def _int_mod_float(self, compiler, call_position: Position, a: Object, b: Object) -> Object:
        ...
        return Object(f'(fmod((float)({a.code}), ({b.code})))', Type('float'), call_position)
    
    @c_dec(param_types=('float', 'int'))
    def _float_mod_int(self, _, call_position: Position, a: Object, b: Object) -> Object:
        return Object(f'(fmod(({a.code}), (float)({b.code})))', Type('float'), call_position)
    
    @c_dec(param_types=('float', 'float'))
    def _float_mod_float(self, _, call_position: Position, a: Object, b: Object) -> Object:
        return Object(f'(fmod(({a.code}), ({b.code}))', Type('float'), call_position)
...
if ({length} > 0) {{
    ...
    def _int_humanize_size(self, compiler, call_position: Position, i: Object) -> Object:
        ...
        abs_call = self._Math_abs(compiler, call_position, Object(x, Type('int'), call_position))
...
for (string {lv} = {temp_var}; *{lv} != '\\0'; ++{lv})
    *{lv} = ({lv} == {temp_var} || *({lv} - 1) == ' ') ? toupper(*{lv}) : tolower(*{lv});""")
        ...
        return Object(temp_var, 'string', call_position, free=temp_free)
...
""")
    ...
    def _Math_ceil(self, compiler, call_position: Position, x: Object) -> Object:
        self.include('<math.h>', compiler)
        return Object(f'((float)ceil({x.code}))', Type('float'), call_position)
    ...
    def _Math_floor(self, compiler, call_position: Position, x: Object) -> Object:
        self.include('<math.h>', compiler)
        return Object(f'((float)floor({x.code}))', Type('float'), call_position)
    ...
    def _Math_round(self, compiler, call_position: Position, x: Object) -> Object:
        self.include('<math.h>', compiler)
        return Object(f'((float)round({x.code}))', Type('float'), call_position)
    
    def _Math_abs2(self, _, call_position: Position, x: Object) -> Object:
        return Object(
            f'(({x.code}) < 0 ? (({x.code})*-1) : ({x.code}))',
    ...
    @c_dec(
        ...
        is_method=True,
        is_static=True,
        overloads={(('int',), 'int'): _Math_abs2}
    )
    def _Math_abs(self, compiler, call_position: Position, x: Object) -> Object:
        self.include('<math.h>', compiler)
        return Object(f'((float)fabs({x.code}))', Type('float'), call_position)
    ...
    def rand_start0(self, compiler, call_position: Position, max: Object) -> Object:
        return self._Math_random(compiler, call_position, Object(0, Type('int'), call_position), max)
    ...
    def _Math_random(self, compiler, call_position: Position, min: Object, max: Object) -> Object:
...
""")
    ...
    def _System_exit2(self, compiler, call_position: Position) -> Object:
    ...
    def _System_exit(self, compiler, call_position: Position, code: Object) -> Object:
        compiler.prepend_code(f'{compiler.get_end_code()}\nexit({code.code});')
        return Object('NULL', Type('nil'), call_position)
...
""")
    ...
    def _Warn(_, call_position: Position, _args: Object, mod_args: Object) -> None:
        msg = mod_args[0].code
    ...
    @staticmethod
    @func_modification(param_types=('string',))
    def _Info(_, call_position: Position, _args: Object, mod_args: Object) -> None:
        msg = mod_args[0].code
        if not msg.startswith('"') and not msg.endswith('"'):
    ...
    @staticmethod
    @func_modification(param_types=('string',))
    def _Error(_, call_position: Position, _args: Object, mod_args: Object) -> None:
        msg = mod_args[0].code
        if not msg.startswith('"') and not msg.endswith('"'):
