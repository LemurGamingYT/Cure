...
class stdlib_h:
    def __init__(self, codegen) -> None:
        ...
        @c_dec(param_types=(Param('div_t', div_t),), is_property=True, add_to_class=self)
        ...
        @c_dec(param_types=(Param('str', Type('string')),), can_user_call=True, add_to_class=self)
        def _atoi(_, call_position: Position, str: Object) -> Object:
            return Object(f'(atoi({str}))', Type('int'), call_position)

        @c_dec(
            param_types=(Param('nitems', size_t), Param('size', size_t)),
        ...
        @c_dec(param_types=(Param('seed', Type('int')),), can_user_call=True, add_to_class=self)
