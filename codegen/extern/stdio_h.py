...
class stdio_h:
    def __init__(self, codegen):
        ...
        @c_dec(param_types=(Param('stream', file_ptr),), can_user_call=True, add_to_class=self)
        def _fclose(_, call_position: Position, stream: Object) -> Object:
            return Object(f'(fclose({stream}))', Type('int'), call_position)

        @c_dec(
            param_types=(Param('filename', Type('string')), Param('mode', Type('string'))),
        ...
        def _fwrite(codegen, call_position: Position, ptr: Object, size: Object, nmemb: Object,
            ...
            if ptr.type == Type('string'):
                ...
                pointer = codegen.create_temp_var(Type('void*'), call_position)
        ...
        @c_dec(param_types=(Param('filename', Type('string')),), can_user_call=True, add_to_class=self)
        ...
        @c_dec(
            param_types=(Param('stream', file_ptr), Param('buffer', Type('string'))),
            can_user_call=True, add_to_class=self
        )
        ...
        @c_dec(
            param_types=(Param('format', Type('string')), Param('*', Type('*'))),
            can_user_call=True, add_to_class=self
        )
