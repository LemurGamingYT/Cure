from codegen.objects import Type, EnvItem
from ir.nodes import Program, FuncDecl
...
class Preprocessor(IRVisitor):
    ...
    def preprocess(self, program: Program) -> None:
        """Pre-process the IR. This currently just forward declares all the functions.
